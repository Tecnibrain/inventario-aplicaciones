...
const INFORMES_INTUNE = {
  ...
  catalogo: ['Catalogo agregado', 'AppInvAggregate',
    ['ApplicationName', 'ApplicationPublisher', 'ApplicationVersion', 'Platform', 'DeviceCount']],
  detalle: ['Detalle crudo por equipo', 'AppInvRawData',
    ['DeviceName', 'UserName', 'ApplicationName', 'ApplicationPublisher', 'ApplicationVersion',
     'Platform', 'OSDescription', 'OSVersion']]
};
