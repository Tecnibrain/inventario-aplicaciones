...
/**
 * Nombre de aplicacion sin la version incrustada.
 *
 * Muchos inventarios la repiten dentro del nombre, y entonces cada version pasa
 * por ser una aplicacion distinta: «desktop_runtime - 8.0.10 (x86)» y
 * «desktop_runtime - 8.0.30 (x86)» acaban siendo dos apps, cada una con una sola
 * version, cada una cumpliendo consigo misma. La version de verdad ya viene en
 * su propia columna, asi que del nombre sobra.
 *
 * Se quitan solo los numeros con AL MENOS un punto. Uno suelto -windows_11,
 * corretto_8, office_16, sql_server_2012- no es una version sino parte del
 * nombre del producto, y quitarlo fundiria cosas que no son la misma.
 */
...
const ROLES = [
  ...
  ['os',     ['osdescription','osdistribution','os','sistemaoperativo','operatingsystem','so','plataforma','platform','osname']],
  ['ts',     ['lastcontact','timestamp','fecha','date','fechareporte','lastseen','ultimavez','ultimoreporte','fechahora',
